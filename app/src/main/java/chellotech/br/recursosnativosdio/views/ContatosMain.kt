...
import chellotech.br.recursosnativosdio.adapters.ContactAdapter
import chellotech.br.recursosnativosdio.model.Contact

class ContatosMain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_contatos_main)
    ...
    private fun setContacts() {
        ...
        val contactRecyclerView = findViewById<RecyclerView>(R.id.recycler_view)
